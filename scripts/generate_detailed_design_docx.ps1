...
$bodyItems = @(
    ...
    "  - scripts/run_simulator.bat shall hand off directly into one visible PowerShell session for the standard-user launch path"
    ...
    "  - scripts/run_simulator.bat = Windows batch wrapper that hands off directly into the one visible PowerShell session for scripts/launch_simulator_ui.ps1"
