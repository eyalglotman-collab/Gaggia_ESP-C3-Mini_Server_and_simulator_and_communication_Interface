...
$bodyItems = @(
    ...
    "  - scripts/run_simulator.bat = Windows batch wrapper that forwards arguments into scripts/run_simulator.ps1 with execution-policy bypass and inherits the same verified-listener replacement behavior"
