...
$bodyItems = @(
    ...
    "  - scripts/run_simulator.bat shall open one visible PowerShell host for the standard-user launch path"
    ...
    "  - scripts/run_simulator.bat = Windows batch wrapper that opens the one visible PowerShell host for scripts/launch_simulator_ui.ps1"
